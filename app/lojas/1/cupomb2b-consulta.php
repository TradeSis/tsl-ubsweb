...
/* programa php - api consultacupomb2b */

$log_datahora_ini = date("dmYHis");
$acao="consultacupomb2b";  
$mypid = getmypid();
...
if ("$conteudoEntrada->idCupom"<>$parametro2) {
    ...
    $conteudoEntrada = json_encode($jsonEntrada);
      ...
      $retorno = $progr->executarprogress("lojas/1/cupomb2b-consulta",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
