...
def temp-table ttitenssaida serialize-name "itens" like ttitens.
define dataset conteudoSaida for ttbag, ttcliente, ttitenssaida.
...
for each ttitens. 
  ...
  create ttitenssaida.
  ttitenssaida.sequencial       = bagprodu.seq.
  ttitenssaida.codigoProduto    = bagprodu.procod.
  ttitenssaida.quantidade       = bagprodu.qtd.
  ttitenssaida.valorUnitario = bagprodu.valorUnitario.
  ttitenssaida.descontoProduto = bagprodu.descontoProduto. /* helio 07062023 */  
  ttitenssaida.valorTotal    = bagprodu.valorTotal.
  ttitenssaida.descricao    = if avail produ then removeAcento(produ.pronom) else "-".
  ttitenssaida.quantidadeConvertida = bagprodu.quantidadeConvertida.  
