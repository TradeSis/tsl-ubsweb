...
if ($conteudoEntrada->cpf<>$parametro2) {
    ...
    $conteudoEntrada = json_encode($jsonEntrada);
      ...
      $retorno = $progr->executarprogress("lojas/1/bag-resgata",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
      ...
      fwrite($arquivo,$identificacao."-SAIDA->".$retorno."\n");
        ...
        if (!isJson($retorno)) {  
            ...
            fwrite($arquivo,$identificacao."-conteudoSaida->".json_encode($conteudoSaida->conteudoSaida["bag"])."\n");
