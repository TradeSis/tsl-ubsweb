...
if ($conteudoEntrada->codCaixa<>$parametro2) {
    ...
    $conteudoEntrada = json_encode($jsonEntrada);
      ...
      $retorno = $progr->executarprogress("lojas/1/reversa-resgatacaixa",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
      ...
      fwrite($arquivo,$identificacao."-SAIDA->".$retorno."\n");
        ...
        if (!isJson($retorno)) {  
            ...
            if ($conteudoSaida->conteudoSaida["reversa"]) {
