...
def temp-table ttofertasmotor  no-undo serialize-name "ofertasmotor"  /* JSON SAIDA */
...
create ttofertasmotor. 
ttofertasmotor.offers = lcOffers.


hsaida  = TEMP-TABLE ttofertasmotor:handle.
