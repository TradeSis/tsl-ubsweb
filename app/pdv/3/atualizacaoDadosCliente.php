<?php
                        ...
                        $acao="atualizacaoDadosCliente_3_";  
...
if (!isset($dadosEntrada)) {
  ...
  //echo "ENTRADA=".$conteudoEntrada;
   ...
   $retorno = $progr->executarprogress("pdv/3/atualizacaodadoscliente",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
