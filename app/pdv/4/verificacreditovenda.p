...
def  temp-table VerificaCreditoVenda serialize-name "dadosEntrada"
    ...
    field taxa_financiamento as char
    field fator_financiamento as char.
            ...
            vprops = 
                ...
                + "&PROP_QTDENOV=" + (if var-QTDENOV = ? then ""  else string(var-QTDENOV))
                   ...
                   /* helio #23112022 ID 154675 */
                    ...
                    /* Lucas 23092024 id 1319 */
                    + "&PROP_PLANO_PAGAMENTO=" + trim(texto(VerificaCreditoVenda.plano_pagamento))
                    + "&PROP_TAXA_FINANCIAMENTO=" + trim(texto(VerificaCreditoVenda.taxa_financiamento))
                    + "&PROP_FATOR_FINANCIAMENTO=" + trim(texto(VerificaCreditoVenda.fator_financiamento))
