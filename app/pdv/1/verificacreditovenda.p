...
/* helio 22052023 Melhoria ID 502416 - Variável ultimas novações */
...
/** helio 04022022 NOVO FLUXO INTEGRACAO MOTOR */
   ...
   run log("CONTINUACAO").
    ...
    then do:
        ...
        then do:
            ...
            vprops = 
                   ...
                   + "&PROP_INSCEST="        + if clien.tippes = no then texto(clien.ciins)  else "" /*#01082022*/
                   + "&PROP_DTNASCCLI="  + 
    ...
    var-saldototnov = dec(pega_prop("SALDOTOTNOV")). /* helio 16122022 - ID 154806 - Verificar envio de variável de novação para o motor */
