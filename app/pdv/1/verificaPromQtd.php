<?php
/* #112022 Gestão de itens promocionais - 2 - bloqueio de quantidade vendida em itens promocionais */


$log_datahora_ini = date("dmYHis");
$acao="verificaPromQtd";  
$mypid = getmypid();
...
$retorno = $progr->executarprogress("pdv/1/verificapromqtd",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
