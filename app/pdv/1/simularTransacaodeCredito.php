...
$acao="simularTransacaodeCredito";  
...
$dadosEntrada = $jsonEntrada["simularTransacaodeCredito"][0];
   ...
   $conteudoEntrada = json_encode(
        array(
            "simularTransacaodeCredito"  =>  
                array($dadosEntrada->simularTransacaodeCredito )
        )
    );
...
//$conteudoEntrada= json_encode($conteudoEntrada);
   ...
   $retorno = $progr->executarprogress("pdv/1/simulartransacaodecredito",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
