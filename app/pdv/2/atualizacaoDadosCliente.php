<?php
                        ...
                        $acao="atualizacaoDadosCliente_2_";  
...
if (!isset($dadosEntrada)) {
  ...
  //echo "ENTRADA=".$conteudoEntrada;
   ...
   $retorno = $progr->executarprogress("pdv/2/atualizacaodadoscliente",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
