...
$acao="calculaLoteSeguroPrestamista";  
$mypid = getmypid();
...
fwrite($arquivo,$identificacao."-ENTRADA->".json_encode($jsonEntrada)."\n");
  ...
  //  $conteudoEntrada=json_encode(array('clienteEntrada' => $jsonEntrada));
   ...
   $retorno = $progr->executarprogress("prestamista/1/calculaloteseguroprestamista",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
