    ...
    array(
      "dadosEntrada" => array(
        "pedidoCartaoLebes" => array(
          array(
            "termoteste" => "TERMOTESTE", // CHAMARA O MESMO PROGRAMA PROGRESS BUSCA TERMOS - AQUI INDICA QUE É PARA PEGAR O TERMO TESTE
            "rascunho" => isset($jsonEntrada->rascunho) ? $jsonEntrada->rascunho : null,
