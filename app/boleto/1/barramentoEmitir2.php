...
//    $conteudo = json_decode(json_encode($jsonEntrada["dadosEntrada"]));
  ...
  //  $conteudoFormatado= json_encode(array("cpfCliente" => $jsonEntrada->cpfCnpjPagador));
    ...
    $service_url = 'http://lebcapp01-prd.matriz.drebes.com.br:5555/gateway/FinanceiroBoletos2/2.0/boleto/emitir?banco=104';
    ...
    if ($info['http_code']==200) {
      $jsonSaida     = array(
              "return"   => array(array(
                    ...
                    "DVNossoNumero"    =>  "",
                    "base64Boleto"  => $result["boleto"]["base64Boleto"]))
            );
    } else {
