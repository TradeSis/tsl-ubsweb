...
$progr = new chamaprogress();
  ...
  $conteudoEntrada=json_encode(array('clientes' => array(array(
                          'cpfCnpj' => $parametro,
                          'idNegociacao' => $parametro2)
                          )));

fwrite($arquivo,$identificacao."-ENTRADAFORMATADO->".json_encode($conteudoEntrada)."\n");
      $retorno = $progr->executarprogress("acordos/1/getnegociacaodetalhada",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
