...
//                    }
    ...
    $conteudoFormatado= json_encode(array("parcelasBoleto" => array(
        "cliente" => array(array(
  ...
  $retorno = $progr->executarprogress("acordos/1/parcelasboleto",$conteudoFormatado,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
