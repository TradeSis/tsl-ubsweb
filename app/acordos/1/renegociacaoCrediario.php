...
$acao="renegociacaoCrediario";  
$mypid = getmypid();
$identificacao=$log_datahora_ini."-PID".$mypid."-"."$acao";
$arqlog = "/ws/log/apiacordos_".$acao."_".date("dmY").".log";
...
//fwrite($arquivo,$identificacao."-ENTRADAFORMATADO->".json_encode($conteudoEntrada)."\n");
      $retorno = $progr->executarprogress("acordos/1/renegociacaocrediario",$conteudoEntrada,$dlc,$pf,$propath,$progresscfg,$tmp,$proginicial);
