...
varqlog = "/u/bsweb/log/p2k05_" + string(today, "99999999") + ".log".
...
procedure AtualizacaoDadosCliente_05.
    def input parameter varquivoentrada as char.
...
procedure VerificaCreditoVenda_05. /* #3 */
...
procedure ConsultaCEP_05. /* #3 */
    ...
    v-return-mode = 
        TEMP-TABLE ConsultaCEP:READ-XML("FILE", varquivoentrada,
                            "EMPTY",  ?, ?, ?, ?).
end procedure.
