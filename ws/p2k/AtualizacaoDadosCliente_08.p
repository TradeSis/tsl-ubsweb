...
then do:
    ...
    assign
        ...
        vcxacod = atualizacaodadoscliente.numero_pdv.
...
then do on error undo:
   ...
   then do:
    ...
    then clien.endereco[1] = caps(texto(atualizacaodadoscliente.endereco)).
            ...
            then do:
                ...
                */    
                ...
                then do:
                   ...
                   + "&PROP_COMPROMETIMENTO_MENSAL="  + trim(string(var-COMPROMETIMENTO_MENSAL,"->>>>>>>>>>>>>>>>>>>>>>>>9.99"))  /* helio 11042022 - ajuste painel motor */
