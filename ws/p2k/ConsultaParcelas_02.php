...
$servidor->wsdl->addComplexType(
    ...
    array(
        ...
        'percentual_encargo_dia' => array('name'=>'codigo_operador','type'=>'xsd:decimal'),
        'data_pagamento' => array('name'=>'codigo_operador','type'=>'xsd:dateTime', 'minOccurs'=>'0', 'nillable'=>'true'),
       'valor_desconto' => array('name'=>'codigo_operador','type'=>'xsd:decimal')
...
//                return $p2k->executarprogress("ConsultaParcelas",$parametro);
                $array2 = array();
                $array2 = $p2k->executarprogress("ConsultaParcelas_02",$parametro);
                return $array2;
