/*
    #1 05.09.19 helio.neto - Titulos indevidos VVI (reprogramado)
*/    
...
def NEW shared temp-table tp-historico
    ...
    for each fin.contrato where fin.contrato.clicod = par-clicod no-lock,
        ...
        if fin.titulo.modcod = "CHQ" or
           fin.titulo.modcod = "DEV" or
           fin.titulo.modcod = "BON" or
           titulo.modcod = "VVI" /*#1*/ or
           length(fin.titulo.titnum) > 11 /* Sujeira de banco */
        then next. /*** ***/
