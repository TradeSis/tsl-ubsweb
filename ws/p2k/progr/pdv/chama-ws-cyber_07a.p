...
clientephp = "http://sv-ca-ac/bsweb/ws/wscyber/cliente/clientecyber_07a.php".

/***
find tab_ini where tab_ini.etbcod = 0
               and tab_ini.cxacod = 0
               and tab_ini.parametro = "P2K - AMBIENTE"
             no-lock no-error.
if avail tab_ini and
   tab_ini.valor = "HOMOLOGACAO"
then clientephp = "http://10.2.0.92/bsweb/ws/wscyber/cliente/clientecyber.php".
***/

varquivo = "/u/bsweb/log/wsretorno.cyber_" + vcpjcnpj + "_" + string(mtime) +
           ".xml".
