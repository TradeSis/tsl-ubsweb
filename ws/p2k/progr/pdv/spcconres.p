...
***/
    ...
    */
    ...
    if substr(vlinha, 1, 6) = "002004"
    then do.
        vok = yes.
/***WS
        find first tt-texto where tt-texto.tipo = 400 no-lock no-error.
        if not avail tt-texto
        then do.
***/
...
/***WS
        ...
        create tt-texto.
        tt-texto.tipo  = 401.
        tt-texto.linha = string( substr(vlinha, 18,20), "x(20)") + " " + 
...
then do on error undo.
    ...
    ***/
    ...
    then do.
        ...
        put "|Filial="    string(setbcod) skip.
