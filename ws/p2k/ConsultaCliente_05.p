...
def var vtipoconsulta          as char init "WsCC".
       ...
       /** Testa se vai para NEUROTECH **/
        ...
        then do:
            ...
            if clien.tippes and
               not avail clispc
            then do.
                varqestatistica = "/u/bsweb/log/p2k_spcsicred_estatistica_" + string(today, "99999999") + ".log".
                ...
                then do:
                    ...
                    vsit_credito = if par-spc then "R" else neuclien.sit_credito.
                    ...
                    run neuro/gravaneuclilog.p
                                (neuclien.cpfcnpj,
                                 ...
                                 consultacliente.numero_pdv,
                                 vsit_credito,
                                 "ADMCOM SPC Cliente " + string(par-spc,"Consta/Nao Consta")).
...
then do:
    ...
    if vcnpj
    then bsxml("cnpj",Texto(clien.ciccgc)).
    else bsxml("cnpj","").
