<?php
        ...
        {
                var $versao;
                var $ws = "p2k_03"; // Letra Minuscula por causa do progress
                ...
                function executarprogress($acao,$novaentrada)
                {
                        ...
                        $arqestatistica = "/u/bsweb/log/p2k".$versao."_estatistica_".date("dmY").".log";
                        ...
                        fwrite($arquivo,date("H:i:s")." METODO=".$acao." FILIAL=".$log_filial." PDV=".$log_pdv."\n");
                        fclose($arquivo);

                        
                        if ("$acao" == "ConsultaCliente_03") {
                        ...
                        if ("$acao" == "ConsultaParcelas_03") {
                                $parametros = "<ConsultaParcelas>".arrayparaxml($xml)."</ConsultaParcelas>";
                        }

                        if ("$acao" == "EfetivaPagamentoPrestacao_03") {
			...
			if ("$acao" == "BuscaDadosContratoNf_03") {
                        ...
                        $arquivo = fopen($arqlog,"a");
                        fwrite($arquivo,date("H:i:s")." METODO=".$acao." FILIAL=".$log_filial." PDV=".$log_pdv." Executou Progress"."\n");
                        fclose($arquivo);
