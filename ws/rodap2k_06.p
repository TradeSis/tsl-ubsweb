...
varqlog = "/ws/log/p2k06_" + string(today, "99999999") + ".log".
...
procedure AtualizacaoDadosCliente_06.
    def input parameter varquivoentrada as char.
...
procedure VerificaCreditoVenda_06. /* #3 */
