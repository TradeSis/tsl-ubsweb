...
varqlog = "/u/bsweb/log/p2k03_" + string(today, "99999999") + ".log".

output to value(varqlog) append.
put unformatted skip
    " Dentro do rodap2k_03.p " string(time, "hh:mm:ss")
    " acao=" vacao skip. 
output close.
...
output to value(varqlog) append.
put unformatted skip
    " Saindo rodap2k_03.p " string(time, "hh:mm:ss")
    " acao=" vacao skip.
output close.
...
procedure ConsultaParcelas_03. /* #2 */
    def input parameter varquivoentrada as char.
