...
#2 Versao 03: ago/2017 - Sala de Guerra
#3 Versao   : Motor de Credito
#4 Versao 04: set/2017 - Nova novacao
*/
...
varqlog = "/u/bsweb/log/p2k04_" + string(today, "99999999") + ".log".

output to value(varqlog) append.
put unformatted skip
    " Dentro do rodap2k_04.p " string(time, "hh:mm:ss")
    " acao=" vacao skip. 
output close.
...
output to value(varqlog) append.
put unformatted skip
    " Saindo rodap2k_04.p " string(time, "hh:mm:ss")
    " acao=" vacao skip.
output close.



procedure ConsultaCliente_03.
    def input parameter varquivoentrada as char.
...
procedure ConsultaParcelas_04. /* #4 */
    def input parameter varquivoentrada as char.
...
procedure efetivaPagamentoPrestacao_03. /* #2 */
    def input parameter varquivoentrada as char.
...
procedure AutorizarEmprestimo_03. /* #2 */
    def input parameter varquivoentrada as char.
...
procedure VerificaCreditoVenda. /* #3 */
    ...
    v-return-mode = 
        TEMP-TABLE VerificaCreditoVenda:READ-XML("FILE", varquivoentrada,
                            "EMPTY",  ?, ?, ?, ?).
end procedure.
