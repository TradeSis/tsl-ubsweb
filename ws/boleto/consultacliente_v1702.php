...
$servidor->wsdl->addComplexType(
	...
	'tipo' => array('name'=>'name','type'=>'xsd:string'),
 	'rua' => array('name'=>'name','type'=>'xsd:string'),
   	'bairro' => array('name'=>'name','type'=>'xsd:string'),
 	'cidade' => array('name'=>'name','type'=>'xsd:string'),
	'estado' => array('name'=>'name','type'=>'xsd:string'),
       ...
       function ConsultaCliente($parametro)
        {
                $boleto = new boleto();
		$array2 = array();
		$array2 = $boleto->executarprogress("consultacliente_v1702",$parametro);
		return $array2;
