...
//$client = new nusoap_client('http://cyb11p01.toppen.com.br:8080/conppwPadrao-war/WSAcordo?wsdl', 'wsdl');  // OFICIAL
$client = new nusoap_client('https://cyber11c01.toppen.com.br:8443/conppwPadrao-war/WSAcordo?wsdl', 'wsdl'); // CONTINGENCIA
