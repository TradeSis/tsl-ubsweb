...
varqlog = "/ws/log/p2k08_" + string(today, "99999999") + ".log".
...
procedure ConsultaCliente_08. /* #6 #7 */
    def input parameter varquivoentrada as char.
...
procedure AtualizacaoDadosCliente_08. /* #6 #7 */
    def input parameter varquivoentrada as char.
...
procedure ConsultaParcelas_07. /* #4 #7 */
    def input parameter varquivoentrada as char.
