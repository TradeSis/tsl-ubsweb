...
varqlog = "/u/bsweb/log/p2k02_" + string(today, "99999999") + ".log".
...
**/
run value(vacao + ".p"). /* chama programa relativo
                                        a funcao no webservice */
...
procedure efetivaPagamentoPrestacao_02.
    def input parameter varquivoentrada as char.
